...
function Farm()
	...
	for i, minion in pairs(EnemyMinions.objects) do
		...
		if WMode == 2 then
			if minion ~= nil and GetDistance(minion) < W.range then
...
function OnDraw()
	if MenuGraves.drawConfig.DST and MenuGraves.comboConfig.ST then
		if SelectedTarget ~= nil and not SelectedTarget.dead then
			DrawCircle2(SelectedTarget.x, SelectedTarget.y, SelectedTarget.z, 100, RGB(MenuGraves.drawConfig.DQRC[2], MenuGraves.drawConfig.DQRC[3], MenuGraves.drawConfig.DQRC[4]))
		end
	end
	if MenuGraves.drawConfig.DAR then			
		DrawCircle2(myHero.x, myHero.y, myHero.z, myHero.range+65, RGB(MenuGraves.drawConfig.DARC[2], MenuGraves.drawConfig.DARC[3], MenuGraves.drawConfig.DARC[4]))
	end
	if MenuGraves.drawConfig.DQR and Q.Ready() then			
		DrawCircle2(myHero.x, myHero.y, myHero.z, Q.range, RGB(MenuGraves.drawConfig.DQRC[2], MenuGraves.drawConfig.DQRC[3], MenuGraves.drawConfig.DQRC[4]))
	end
	if MenuGraves.drawConfig.DWR and W.Ready() then			
		DrawCircle2(myHero.x, myHero.y, myHero.z, W.range, RGB(MenuGraves.drawConfig.DWRC[2], MenuGraves.drawConfig.DWRC[3], MenuGraves.drawConfig.DWRC[4]))
	end
	if MenuGraves.drawConfig.DER and E.Ready() then			
		DrawCircle2(myHero.x, myHero.y, myHero.z, E.range, RGB(MenuGraves.drawConfig.DERC[2], MenuGraves.drawConfig.DERC[3], MenuGraves.drawConfig.DERC[4]))
	end
	if MenuGraves.drawConfig.DRR and R.Ready() then			
		DrawCircle2(myHero.x, myHero.y, myHero.z, R.range, RGB(MenuGraves.drawConfig.DRRC[2], MenuGraves.drawConfig.DRRC[3], MenuGraves.drawConfig.DRRC[4]))
	end
end
