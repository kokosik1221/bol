...
function Menu()
	...
	MenuLulu.ss:addParam("sep", "",                          SCRIPT_PARAM_INFO, "")
	...
	MenuLulu.harrasConfig:permaShow("HEnabled")
	MenuLulu.harrasConfig:permaShow("HTEnabled")
	MenuLulu.farm:permaShow("LaneClear")
	MenuLulu.jf:permaShow("JFEnabled")
	MenuLulu.exConfig:permaShow("UI")
	MenuLulu.exConfig:permaShow("UG")
	MenuLulu.prConfig:permaShow("AZ")
end
...
function Farm()
	EnemyMinions:update()
	local QMode =  MenuLulu.farm.QF
	local EMode =  MenuLulu.farm.EF
	for i, minion in pairs(EnemyMinions.objects) do
		if QMode == 3 then
			if minion ~= nil and ValidTarget(minion, Q.range) and Q.Ready() then
...
function OnDraw()
	if MenuLulu.drawConfig.DST and MenuLulu.comboConfig.oConfig.ST then
		if SelectedTarget ~= nil and not SelectedTarget.dead then
			DrawCircle2(SelectedTarget.x, SelectedTarget.y, SelectedTarget.z, 100, RGB(MenuLulu.drawConfig.DQRC[2], MenuLulu.drawConfig.DQRC[3], MenuLulu.drawConfig.DQRC[4]))
		end
	end
	...
	if MenuLulu.drawConfig.DAAR then			
		DrawCircle2(myHero.x, myHero.y, myHero.z, myHero.range + 65, RGB(MenuLulu.drawConfig.DAARC[2], MenuLulu.drawConfig.DAARC[3], MenuLulu.drawConfig.DAARC[4]))
	end
	if MenuLulu.drawConfig.DQR and Q.Ready() then			
		DrawCircle2(myHero.x, myHero.y, myHero.z, Q.range, RGB(MenuLulu.drawConfig.DQRC[2], MenuLulu.drawConfig.DQRC[3], MenuLulu.drawConfig.DQRC[4]))
	end
	if MenuLulu.drawConfig.DWR and (W.Ready() or E.Ready()) then			
		DrawCircle2(myHero.x, myHero.y, myHero.z, W.range, RGB(MenuLulu.drawConfig.DWRC[2], MenuLulu.drawConfig.DWRC[3], MenuLulu.drawConfig.DWRC[4]))
	end
	if MenuLulu.drawConfig.DRR and R.Ready() then			
		DrawCircle2(myHero.x, myHero.y, myHero.z, R.range, RGB(MenuLulu.drawConfig.DRRC[2], MenuLulu.drawConfig.DRRC[3], MenuLulu.drawConfig.DRRC[4]))
	end
end
